...
newtype ImpSpecF k z s l lexicalAnnotation grammarAnnotation annotation fixpoint = MkImpSpecF { _unImpSpecF :: (ImpSpecBase (,) Prelude.Maybe [] (l (LexicalLeftParenthesisKeyBase k z s)) (Import_ k z s l lexicalAnnotation lexicalAnnotation) (l (LexicalCommaKeyBase k z s)) (l (LexicalRightParenthesisKeyBase k z s)) (LexicalHiding k z s l lexicalAnnotation lexicalAnnotation) annotation fixpoint) }
...
newtype ContextF k z s l lexicalAnnotation grammarAnnotation annotation fixpoint = MkContextF { _unContextF :: (ContextBase (,) Prelude.Maybe [] (Class_ k z s l lexicalAnnotation lexicalAnnotation) (l (LexicalLeftParenthesisKeyBase k z s)) (l (LexicalCommaKeyBase k z s)) (l (LexicalRightParenthesisKeyBase k z s)) annotation fixpoint) }
...
newtype ConstrF k z s l lexicalAnnotation grammarAnnotation annotation fixpoint = MkConstrF { _unConstrF :: (ConstrBase (,) [] Prelude.Either Prelude.Maybe (Con k z s l lexicalAnnotation grammarAnnotation grammarAnnotation) (EvalAtype k z s l lexicalAnnotation grammarAnnotation grammarAnnotation) btype conop lexicalLeftBrace (FieldDecl k z s l lexicalAnnotation grammarAnnotation grammarAnnotation) (LexicalComma k z s l lexicalAnnotation lexicalAnnotation) (LexicalRightBrace k z s l lexicalAnnotation lexicalAnnotation) annotation fixpoint) }
